        ...
        children: [
          Column(
            ...
            children: [
              ...
              HoraSeleccionable(hora: const TimeOfDay(hour: 8, minute: 00), focusNode: focusNode1),
              HoraSeleccionable(hora: const TimeOfDay(hour: 9, minute: 00), focusNode: focusNode2),
              HoraSeleccionable(hora: const TimeOfDay(hour: 10, minute: 00), focusNode: focusNode3),
              HoraSeleccionable(hora: const TimeOfDay(hour: 11, minute: 00), focusNode: focusNode4),
            ],
          ),
          Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              HoraSeleccionable(hora: const TimeOfDay(hour: 12, minute: 00), focusNode: focusNode5),
              HoraSeleccionable(hora: const TimeOfDay(hour: 13, minute: 00), focusNode: focusNode6),
              HoraSeleccionable(hora: const TimeOfDay(hour: 14, minute: 00), focusNode: focusNode7),
              HoraSeleccionable(hora: const TimeOfDay(hour: 15, minute: 00), focusNode: focusNode8),
            ],
          ),
          Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              HoraSeleccionable(hora: const TimeOfDay(hour: 16, minute: 00), focusNode: focusNode9),
              HoraSeleccionable(hora: const TimeOfDay(hour: 17, minute: 00), focusNode: focusNode10),
              HoraSeleccionable(hora: const TimeOfDay(hour: 18, minute: 00), focusNode: focusNode11),
              HoraSeleccionable(hora: const TimeOfDay(hour: 19, minute: 00), focusNode: focusNode12),
            ],
          )
        ],
      ),
